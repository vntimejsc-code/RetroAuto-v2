...
def test_scenario_1_missing_asset():
    ...
    from core.models import Script, Flow, ClickImage, Delay
...
def test_scenario_3_nested_conditionals():
    ...
    from core.models import IfImage, ClickImage, Delay
    ...
    try:
        ...
        outer_if = IfImage(
            asset_id="main_menu",
            then_actions=[
                ClickImage(asset_id="start_button"),
                inner_if  # Nested conditional
            ],
            else_actions=[Delay(ms=1000)]
        )
        
        print(f"✓ Created nested conditional structure")
...
def test_scenario_5_graph_execution():
    ...
    from core.models import Flow, Delay, ClickImage
...
def test_scenario_6_serialization_roundtrip():
    ...
    from core.models import Script, Flow, IfText, ReadText, Delay
    import yaml
