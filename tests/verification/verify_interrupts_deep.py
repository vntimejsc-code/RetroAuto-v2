...
from core.models import InterruptRule, Action
from core.engine.context import ExecutionContext, EngineState
...
class TestInterruptsDeep(unittest.TestCase):
    ...
    def test_cooldown_logic(self):
        ...
        self.assertEqual(self.runner.run_flow.call_count, 1, "Cooldown failed, triggered multiple times")
