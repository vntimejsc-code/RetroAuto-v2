...
def test_models_validation():
    ...
    from core.models import (
        ClickImage, WaitImage, Delay, IfImage, IfText, 
        ReadText, Hotkey, Loop, Flow, Script, ROI
    )
    import yaml
    ...
    try:
        ...
        print(f"✓ Deserialized from YAML")
...
def test_action_union():
    ...
    try:
        from core.models import Action, ClickImage, WaitImage, IfText, ReadText
