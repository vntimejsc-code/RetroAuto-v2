...
from core.models import FlowGraph, GraphNode, GraphConnection, Action
...
class GraphWalker:
    ...
    def get_next_node(self, current_id: str, branch_result: Any = None) -> GraphNode | None:
        ...
        exec_connections = [c for c in connections if c.from_socket in ("exec_out", "true_out", "false_out")]
