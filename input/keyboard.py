...
VK_CODES: dict[str, int] = {
    ...
    "WIN": win32con.VK_LWIN, "LWIN": win32con.VK_LWIN, "RWIN": win32con.VK_RWIN,
    # Special keys
    "ENTER": win32con.VK_RETURN, "RETURN": win32con.VK_RETURN,
    "TAB": win32con.VK_TAB, "ESC": win32con.VK_ESCAPE, "ESCAPE": win32con.VK_ESCAPE,
    "SPACE": win32con.VK_SPACE, "BACKSPACE": win32con.VK_BACK, "BACK": win32con.VK_BACK,
    "DELETE": win32con.VK_DELETE, "DEL": win32con.VK_DELETE,
    "INSERT": win32con.VK_INSERT, "INS": win32con.VK_INSERT,
    "HOME": win32con.VK_HOME, "END": win32con.VK_END,
    "PAGEUP": win32con.VK_PRIOR, "PGUP": win32con.VK_PRIOR,
    "PAGEDOWN": win32con.VK_NEXT, "PGDN": win32con.VK_NEXT,
    # Arrow keys
...
class KeyboardController:
    ...
    def type_text(
        ...
        logger.debug("Typed text: %s... (paste=%s)", text[:20] if len(text) > 20 else text, paste_mode)
